...
// Guardem els posts transformats en un arxiu JSON
writeFileSync('posts.json', JSON.stringify(transformedPosts, null, 2));//Guardem els posts transformats en un arxiu JSON
console.log('Posts guardats en posts.json'); //Mostrem un missatge per pantalla